        ...
        <div className="min-h-screen bg-gradient-to-br from-purple-900 via-indigo-900 to-blue-900 flex items-center justify-center p-6">
            <div className="w-full max-w-md">
                ...
                <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
                    ...
                    <p className="text-purple-200 mb-8">Create your account and start designing with AI</p>
                    ...
                    <p className="text-center text-purple-200 mt-6">
                        ...
                        <Link href="/auth/login" className="text-white font-semibold hover:text-purple-100">
                            Sign in
                        </Link>
                    </p>
                </div>
